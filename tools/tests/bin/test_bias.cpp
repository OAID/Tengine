...
const char* model_file = "./models/bias.tmfile";
const char* image_file = "./tests/images/cat.jpg";
const char* label_file = "./models/synset_words.txt";

float result[27] = {0.163189, -0.736811, 0.363189, -0.536811, 
                    0.563189, -0.336811, 0.763189, -0.136811,
                    0.963189, 0.442449, 1.542449, 0.642449,
                    1.742449, 0.842449, 1.942448, 1.042449,
                    2.142448, 1.242449, 2.544990, 1.644990,
                    2.744990, 1.844990, 2.944990, 2.044990,
                    3.144990, 2.244990, 3.344990};
...
int main(int argc, char* argv[])
{
    ...
    for(int i = 0; i < size; i++)
    {
        ...
        float tmp = abs(data[i]) - abs(result[i]);
        if(tmp > 0.00001){
            printf("Test Failed \n");
            return 0;
        }
