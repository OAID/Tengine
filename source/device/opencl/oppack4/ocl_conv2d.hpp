...
#ifndef TENGINE_LITE_SOURCE_DEVICE_OPENCL_OPPACK4_OCL_CONV2D_H_
#define TENGINE_LITE_SOURCE_DEVICE_OPENCL_OPPACK4_OCL_CONV2D_H_
...
class ocl_conv2d : public ocl_node
{
public:
    ocl_conv2d(OCLEngine* engine, struct node* ir_node);
...
#endif //TENGINE_LITE_SOURCE_DEVICE_OPENCL_OPPACK4_OCL_CONV2D_H_
