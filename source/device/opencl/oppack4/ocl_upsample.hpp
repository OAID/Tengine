...
#ifndef TENGINE_LITE_SOURCE_DEVICE_OPENCL_OPPACK4_OCL_UPSAMPLE_HPP_
#define TENGINE_LITE_SOURCE_DEVICE_OPENCL_OPPACK4_OCL_UPSAMPLE_HPP_

#include "ocl_cpp_helper.hpp"
#include "ocl_node.hpp"

class ocl_upsample : public ocl_node
{
public:
    ocl_upsample(OCLEngine* engine, struct node* ir_node);
