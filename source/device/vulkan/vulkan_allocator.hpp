...
protected:
    ...
    VkImage create_image(VkImageType type, int width, int height, int depth, VkFormat format, VkImageTiling tiling,
...
public:
    virtual VkBufferMemory* fastMalloc(size_t size);
    virtual void fastFree(VkBufferMemory* ptr);
    virtual VkImageMemory* fastMalloc(int /*dims*/, int /*w*/, int /*h*/, int /*c*/, size_t /*elemsize*/,
                                      int /*elempack*/)
    {
        return 0;
    }
