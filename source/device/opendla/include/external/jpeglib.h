...
EXTERN(void)
jpeg_CreateCompress(j_compress_ptr cinfo, int version,
                    size_t structsize);
EXTERN(void)
jpeg_CreateDecompress(j_decompress_ptr cinfo, int version,
                      size_t structsize);
...
/* Same, but piecemeal. */
EXTERN(void)
jpeg_write_m_header(j_compress_ptr cinfo, int marker,
...
EXTERN(JDIMENSION)
jpeg_skip_scanlines(j_decompress_ptr cinfo,
                    JDIMENSION num_lines);
EXTERN(void)
