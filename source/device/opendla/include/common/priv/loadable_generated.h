...
MANUALLY_ALIGNED_STRUCT(1)
Version FLATBUFFERS_FINAL_CLASS
{
private:
    uint8_t major_;
    uint8_t minor_;
...
struct Blob FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_NAME) && verifier.Verify(name()) && VerifyField<uint64_t>(verifier, VT_SIZE) && VerifyField<uint32_t>(verifier, VT_INTERFACE) && VerifyField<uint32_t>(verifier, VT_SUB_INTERFACE) && VerifyField<Version>(verifier, VT_VERSION) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_DATA) && verifier.Verify(data()) && verifier.EndTable();
    }
};
...
struct MemoryListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<uint8_t>(verifier, VT_DOMAIN) && VerifyField<uint16_t>(verifier, VT_FLAGS) && VerifyField<uint64_t>(verifier, VT_SIZE) && VerifyField<uint32_t>(verifier, VT_ALIGNMENT) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_CONTENTS) && verifier.Verify(contents()) && verifier.VerifyVectorOfStrings(contents()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_OFFSETS) && verifier.Verify(offsets()) && VerifyField<uint16_t>(verifier, VT_BIND_ID) && VerifyField<uint16_t>(verifier, VT_TENSOR_DESC_ID) && verifier.EndTable();
    }
};
...
struct EventListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<uint8_t>(verifier, VT_TYPE) && VerifyField<uint16_t>(verifier, VT_TARGET) && VerifyField<uint32_t>(verifier, VT_VAL) && VerifyField<uint8_t>(verifier, VT_OP) && verifier.EndTable();
    }
};
...
struct TaskListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<uint32_t>(verifier, VT_INTERFACE) && VerifyField<int16_t>(verifier, VT_INSTANCE) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ADDRESS_LIST) && verifier.Verify(address_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_PRE_ACTIONS) && verifier.Verify(pre_actions()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_POST_ACTIONS) && verifier.Verify(post_actions()) && verifier.EndTable();
    }
};
...
struct AddressListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<uint16_t>(verifier, VT_MEM_ID) && VerifyField<uint64_t>(verifier, VT_OFFSET) && VerifyField<uint64_t>(verifier, VT_SIZE) && verifier.EndTable();
    }
};
...
struct SubmitListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_TASK_ID) && verifier.Verify(task_id()) && verifier.EndTable();
    }
};
...
struct TensorDescListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_NAME) && verifier.Verify(name()) && VerifyField<uint16_t>(verifier, VT_ID) && VerifyField<uint16_t>(verifier, VT_MEM_ID) && VerifyField<uint64_t>(verifier, VT_SIZE) && VerifyField<uint64_t>(verifier, VT_OFFSET) && VerifyField<uint8_t>(verifier, VT_DATA_FORMAT) && VerifyField<uint8_t>(verifier, VT_DATA_TYPE) && VerifyField<uint8_t>(verifier, VT_DATA_CATEGORY) && VerifyField<uint8_t>(verifier, VT_PIXEL_FORMAT) && VerifyField<uint8_t>(verifier, VT_PIXEL_MAPPING) && VerifyField<int32_t>(verifier, VT_N) && VerifyField<int32_t>(verifier, VT_C) && VerifyField<int32_t>(verifier, VT_H) && VerifyField<int32_t>(verifier, VT_W) && VerifyField<uint32_t>(verifier, VT_STRIDE_0) && VerifyField<uint32_t>(verifier, VT_STRIDE_1) && VerifyField<uint32_t>(verifier, VT_STRIDE_2) && VerifyField<uint32_t>(verifier, VT_STRIDE_3) && VerifyField<uint32_t>(verifier, VT_STRIDE_4) && VerifyField<uint32_t>(verifier, VT_STRIDE_5) && VerifyField<uint32_t>(verifier, VT_STRIDE_6) && VerifyField<uint32_t>(verifier, VT_STRIDE_7) && verifier.EndTable();
    }
};
...
struct RelocListEntry FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_ADDRESS_ID) && VerifyField<uint16_t>(verifier, VT_WRITE_ID) && VerifyField<uint64_t>(verifier, VT_OFFSET) && VerifyField<uint32_t>(verifier, VT_INTERFACE) && VerifyField<uint32_t>(verifier, VT_SUB_INTERFACE) && VerifyField<uint8_t>(verifier, VT_RELOC_TYPE) && verifier.EndTable();
    }
};
...
struct Loadable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier& verifier) const
    {
        return VerifyTableStart(verifier) && VerifyFieldRequired<Version>(verifier, VT_VERSION) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_TASK_LIST) && verifier.Verify(task_list()) && verifier.VerifyVectorOfTables(task_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_MEMORY_LIST) && verifier.Verify(memory_list()) && verifier.VerifyVectorOfTables(memory_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ADDRESS_LIST) && verifier.Verify(address_list()) && verifier.VerifyVectorOfTables(address_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_EVENT_LIST) && verifier.Verify(event_list()) && verifier.VerifyVectorOfTables(event_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_BLOBS) && verifier.Verify(blobs()) && verifier.VerifyVectorOfTables(blobs()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_TENSOR_DESC_LIST) && verifier.Verify(tensor_desc_list()) && verifier.VerifyVectorOfTables(tensor_desc_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_RELOC_LIST) && verifier.Verify(reloc_list()) && verifier.VerifyVectorOfTables(reloc_list()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_SUBMIT_LIST) && verifier.Verify(submit_list()) && verifier.VerifyVectorOfTables(submit_list()) && verifier.EndTable();
    }
};
