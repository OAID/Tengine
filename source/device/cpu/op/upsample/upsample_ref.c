...
static int ref_upsample_fp32(struct tensor* input_tensor, struct tensor* output_tensor, struct upsample_param* param,
                             int num_thread)
{
...
static int ref_upsample_uint8(struct tensor* input_tensor, struct tensor* output_tensor, struct upsample_param* param,
                              int num_thread)
{
    float* input  = input_tensor->data;
    float* output = output_tensor->data;
