...
static int ref_psroipooling_fp32(struct tensor* featmap_tensor, struct tensor* roi_tensor, struct tensor* output_tensor,
                                 struct psroipooling_param* param, int num_thread)
{
