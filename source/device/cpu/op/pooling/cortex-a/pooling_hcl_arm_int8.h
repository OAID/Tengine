...
typedef void (*pooling_kernel_int8_t)(const void* input, void* output, int inc, int inh, int inw, int outh, int outw,
                                      int k_h, int k_w, int s_h, int s_w, int pad_h0, int pad_w0, int pad_h1,
                                      int pad_w1, int is_caffe, float in_scale, float out_scale);
...
static void pad_0_align_3D_int8(int8_t* dst, int8_t* src, int m, int n, int m_align, int n_align, int c, int pad_h,
                                int pad_w)
{
    int i;
    if (n >= n_align && m >= m_align)
...
// pad 0 in right and down side on 3D
static void delete_0_3D_int8(int8_t* dst, int8_t* src, int m_align, int n_align, int m, int n, int c, int pad_h,
                             int pad_w)
{
    int i;
    if (n >= n_align && m >= m_align)
