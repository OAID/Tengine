        ...
        for (int c = 0; c < channel; c++)
        {
            for (int ph = 0; ph < out_h; ph++)
            {
                for (int pw = 0; pw < out_w; pw++)
                {
                    ...
                    {
                        int8_t max = calc_max_int8(input_cur, layout, channel, in_h, in_w, c, h_start, w_start, h_end, w_end);
                    ...
                    {
                        int32_t sum_i32 = calc_sum_int8(input_cur, layout, channel, in_h, in_w, c, h_start, w_start, h_end, w_end);
