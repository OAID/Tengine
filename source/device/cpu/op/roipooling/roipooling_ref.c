...
static int ref_roipooling_fp32(struct tensor* input_tensor, struct tensor* roi_tensor, struct tensor* output_tensor,
                               struct roipooling_param* param, int num_thread)
{
