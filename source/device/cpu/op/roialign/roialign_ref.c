...
static int ref_roialign_fp32(struct tensor* input_tensor, struct tensor* roi_tensor, struct tensor* output_tensor,
                             struct roialign_param* param, int num_thread)
{
