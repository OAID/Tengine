...
int BilinearSampling(int o_n, int o_c, int o_h, int o_w, int i_c, int i_h, int i_w, float* in_data, float* out_data,
                     float* grid_total)
{
...
static int run(struct node_ops* node_ops, struct exec_node* exec_node, struct exec_graph* exec_graph)
{
    ...
    int ret = ref_spatialtransformer_fp32(input_tensor, input_tensor1, output_tensor, spatialtransformer_param,
