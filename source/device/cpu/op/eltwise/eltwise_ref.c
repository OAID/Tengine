...
static int ref_eltwise_fp32(void* output, void* input0, void* input1, int type, int input_count4, int input_chan,
                            int input_hw, int input1_count4, int num_thread, int input_hw_1,
...
static int ref_eltwise_uint8(struct tensor* output_tensor, struct tensor* input_tensor0, struct tensor* input_tensor1,
                             int type, int input_count4, int input_chan, int input_hw, int input1_count4,
                             int num_thread, int input_hw_1, struct eltwise_param* eltwise_param)
{
...
static int ref_eltwise_int8(struct tensor* output_tensor, struct tensor* input_tensor0, struct tensor* input_tensor1,
                            int type, int input_count4, int input_chan, int input_hw, int input1_count4, int num_thread,
                            int input_hw_1, struct eltwise_param* eltwise_param)
{
    ...
    if (!input_tensor1 || input_tensor0->elem_num >= input_tensor1->elem_num)
    {
        ...
        if (input_tensor0->data_type == TENGINE_DT_FP32)
            ...
            ret = ref_eltwise_uint8(output_tensor, input_tensor0, input_tensor1, eltwise_param->type, input0_count4,
                                    input_chan_0, input_hw_0, input1_count4, exec_graph->num_thread, input_hw_1,
                                    eltwise_param);
