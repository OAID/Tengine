...
void ConvertPaddingStyleToParameters(int stride_h, int stride_w, int in_height, int in_width, int filter_height,
                                     int filter_width, int paddingtype, int out_height, int out_width,
