 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int get_node_attr_int(node_t node, const char* attr_name,
 ...
 *         -1: Failed, the name does not exist or the type mismatch.
 */
DLLEXPORT DEPRECATED_BEFORE int get_node_attr_float(node_t node, const char* attr_name,
 ...
 *         -1: Failed, the name does not exist or the type mismatch.
 */
DLLEXPORT DEPRECATED_BEFORE int get_node_attr_pointer(node_t node, const char* attr_name,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int get_node_attr_generic(node_t node, const char* attr_name, const char* type_name,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int set_node_attr_int(node_t node, const char* attr_name,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int set_node_attr_float(node_t node, const char* attr_name,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int set_node_attr_pointer(node_t node, const char* attr_name,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int set_node_attr_generic(node_t node, const char* attr_name, const char* type_name,
 ...
 * @return 0: Success, -1: Fail.
 */
DLLEXPORT DEPRECATED_BEFORE int set_custom_kernel(node_t node, const char* dev_name,
 ...
 * @return 0: Success, -1: Fail.
 */
DLLEXPORT DEPRECATED_BEFORE int set_graph_attr(graph_t graph, const char* attr_name, const void* buf,
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int get_graph_attr(graph_t graph, const char* attr_name, void* buf,
                                               int size) DEPRECATED_AFTER;
 ...
 *
 */
DLLEXPORT DEPRECATED_BEFORE int set_graph_event_hook(graph_t graph, int event, event_handler_t cb_func,
 ...
 *  @return 0: Success, -1: Fail.
 */
DLLEXPORT int set_context_device(context_t context, const char* dev_name, const void* dev_option,
                                 size_t dev_opt_size);
 ...
 * @return 0: Success, -1: Fail.
 */
DLLEXPORT DEPRECATED_BEFORE int set_context_attr(context_t context, const char* attr_name, const void* val,
 ...
 */
DLLEXPORT DEPRECATED_BEFORE int get_context_attr(context_t context, const char* attr_name, void* val,
                                                 int val_size) DEPRECATED_AFTER;
