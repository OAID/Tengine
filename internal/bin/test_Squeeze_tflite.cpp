...
const char* model_path = "./models/Squeeze.tflite";
...
int main(int argc, char* argv[])
{
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_squeeze.txt");

    getdatacompare("./out/test_tflite_squeeze.txt","./data/squeeze_tflite_out.txt");
