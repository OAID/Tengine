...
const char* model_path = "./models/Strided_Slice.tflite";
...
int main(int argc, char* argv[])
{
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_stridedslice.txt");

    getdatacompare("./out/test_tflite_stridedslice.txt","./data/stridedslice_tflite_out.txt");
