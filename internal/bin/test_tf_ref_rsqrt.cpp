...
std::string model_name = "./models/tensorflow/test_rsqrt.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/rsqrt_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_rsqrt_out.txt");
