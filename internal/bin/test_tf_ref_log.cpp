...
std::string model_name = "./models/tensorflow/test_log.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/log_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_log_out.txt");
