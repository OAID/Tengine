...
const char* model_path = "./models/RUL1.tflite";
...
int main(int argc, char* argv[])
{
    ...
    set_input_data(input_data, 2, flatten_size);
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_relu1.txt");

    getdatacompare("./out/test_tflite_relu1.txt","./data/relu1_tflite_out.txt");
