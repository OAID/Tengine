...
std::string model_name = "./models/tensorflow/test_exp.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/exp_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_exp_out.txt");
