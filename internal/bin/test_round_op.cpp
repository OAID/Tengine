...
{
    node_t test_node = create_graph_node(graph, "Round", "Round");
    ...
    /* output */
    tensor_t output_tensor = create_graph_tensor(graph, "Round", TENGINE_DT_INT32);
...
{  
    ...
    dump_graph(graph);
    node_t test_node = get_graph_node(graph, "Round");
