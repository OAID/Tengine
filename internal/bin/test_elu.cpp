...
int create_test_node(graph_t graph, const char* node_name, const char* input_name, int data_type, float alpha)
{
    node_t test_node = create_graph_node(graph, node_name, "Elu");
...
graph_t create_test_graph(const char* test_node_name, int c, int h, int w, int layout, int data_type, float alpha)
{
    ...
    if(create_test_node(graph, test_node_name, input_name, data_type, alpha) < 0)
    {
...
int test_op(int c, int h, int w, const char* test_node_name, int layout, int data_type, float alpha)
{
    graph_t graph = create_test_graph(test_node_name, c, h, w, layout, data_type, alpha);
    ...
    infp=fopen("./data/elu_out.bin","rb");
...
int main(int argc, char* argv[])
{
    ...
    test_op(c, h, w, test_node_name, layout, data_type, alpha);
