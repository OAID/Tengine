...
const char* model_path = "./models/ResizeNearestNeighbor.tflite";
const std::vector<float> test_data1 = {-1.1, 0.6, 0.4, 0.3, 
                                        1.1, 0.2, 0.4, 0.5,
                                        0.7, 0.5, 0.3, 0.2,
                                        1.4, 1.3, 1.1, 0.1};
...
int main(int argc, char* argv[])
{
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_resize_nearest_neighbor.txt");

    getdatacompare("./out/test_tflite_resize_nearest_neighbor.txt","./data/resize_nearest_neighbor_tflite_out.txt");
