...
int create_test_node(graph_t graph, const char* node_name, const char* input_name, int data_type, int resize_type)
{
    node_t test_node = create_graph_node(graph, node_name, "Interp");
    ...
    int output_width = 0;
    int output_height = 0;
    float width_scale = 2.0;
    float height_scale = 2.0;
    set_node_attr_int(test_node, "resize_type", &resize_type);
    set_node_attr_int(test_node, "output_width", &output_width);
    set_node_attr_int(test_node, "output_height", &output_height);
    set_node_attr_float(test_node, "width_scale", &width_scale);
    set_node_attr_float(test_node, "height_scale", &height_scale);
    release_graph_node(test_node);

    return 0;
}

graph_t create_test_graph(const char* test_node_name, int c, int h, int w, int layout, int data_type, int resize_type)
{
    ...
    if(create_test_node(graph, test_node_name, input_name, data_type, resize_type) < 0)
    {
...
int test_cast(int c, int h, int w, const char* test_node_name, int layout, int data_type, int resize_type)
{
    graph_t graph = create_test_graph(test_node_name, c, h, w, layout, data_type, resize_type);
    ...
    FILE *infp;  
    infp=fopen("./data/interp_in.bin","rb");
    ...
    infp=fopen("./data/interp_out.bin","rb");
...
int main(int argc, char* argv[])
{
    ...
    test_cast(c, h, w, test_node_name, layout, data_type, 2);
