...
std::string model_name = "./models/tensorflow/test_pad.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/pad_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_pad_out.txt");
