...
const char* model_path = "./models/l2pool2S.tflite";
...
int main(int argc, char* argv[])
{
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_l2pool.txt");

    getdatacompare("./out/test_tflite_l2pool.txt","./data/l2pool_tflite_out.txt");
