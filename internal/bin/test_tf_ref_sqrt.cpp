...
std::string model_name = "./models/tensorflow/test_sqrt.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/sqrt_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_sqrt_out.txt");
