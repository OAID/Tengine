...
std::string model_name = "./models/tensorflow/test_reduce_mean.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/reduce_mean_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_reduce_mean_out.txt");
