...
const char* model_path = "./models/log_softmax.tflite";
...
int main(int argc, char* argv[])
{
    ...
    dump_kernel_value(output_tensor,"./out/test_tflite_logsoftmax.txt");

    getdatacompare("./out/test_tflite_logsoftmax.txt","./data/logsoftmax_tflite_out.txt");
