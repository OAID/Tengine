...
std::string model_name = "./models/tensorflow/test_reduce_sum.pb";
...
int main(int argc, char* argv[])
{
    ...
    getdatanptxt(input_size, input_data, "./tests/data/reduce_sum_input.txt");
    ...
    dump_kernel_value(output_tensor, "./tests/data/test_reduce_sum_out.txt");
