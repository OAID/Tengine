...
const char* text_file = "./models/broadcast_mul.json";
//const char* text_file = "./models/broadcast_mul.tmfile";
const char* model_file = "./models/broadcast_mul.params";
...
//    graph_t graph = create_graph(nullptr, "tengine", text_file);
   ...
   // }
    if(data[0] - 1.433 > 0.01 || data[1] + (0.487) > 0.01)
    {
        printf("NO PASS\n");
    }
    else
