...
{
    node_t test_node = create_graph_node(graph, node_name, "Reshape");
    ...
    // const int axis;
    // const int axis=0;
    set_node_attr_int(test_node, "dim_0", &dim_0);
    set_node_attr_int(test_node, "dim_1", &dim_1);
    set_node_attr_int(test_node, "dim_2", &dim_2);
    set_node_attr_int(test_node, "dim_3", &dim_3);
