...
class NodeDriver : public Driver {
 public:
  ...
  virtual bool OptimizeGraph(Device* dev, void* graph_handle,
                             Subgraph* graph) override {
    return false;
  }
  bool OptimizeGraph(Device* dev, void* graph_handle) override { return false; }

  bool Prerun(Device* dev, void* graph_handle) override { return false; }
  bool Run(Device* dev, void* graph_handle) override { return false; }
  bool SyncRun(Device* dev, void* graph_handle) override { return false; }
  bool Postrun(Device* dev, void* graph_handle) override { return false; }
  ...
  int GetDevIDTableSize(void) { return dev_id_.size(); }
  const dev_id_t& GetDevIDByIdx(int n) { return dev_id_[n]; }
  ...
  virtual bool InitDev(NodeDevice* device) { return true; }
  virtual bool ReleaseDev(NodeDevice* device) { return true; }
  virtual bool StartDev(NodeDevice* device) { return true; }
  virtual bool StopDev(NodeDevice* device) { return true; }
