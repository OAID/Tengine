...
void bn_scale_relu_neon(const float *__restrict__ input,
                        const float *__restrict__ gamma,
                        const float *__restrict__ beta,
                        const float *__restrict__ mean,
                        const float *__restrict__ var, int channel_number,
                        int channel_size, float *__restrict__ output) {
...
void RegisterCommonFusedBNScaleReluNodeExec(void) {
  ...
  NodeOpsRegistryManager::RegisterOPImplementor(
      "common", FusedBNScaleReLu::class_name, ops);
}
