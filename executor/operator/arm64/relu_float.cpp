...
using namespace ReluFP32Impl64;

void RegisterReluFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm64", "ReLu", ReluFP32Impl64::SelectFunc, ReluFP32Impl64::default_prio);
}
