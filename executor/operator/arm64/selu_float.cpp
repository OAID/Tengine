...
using namespace SeluFP32Impl64;

void RegisterSeluFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm64", "Selu", SeluFP32Impl64::SelectFunc, SeluFP32Impl64::default_prio);
}
