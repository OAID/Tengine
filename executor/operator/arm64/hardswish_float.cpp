...
using namespace HardswishFP32Impl64;

void RegisterHardswishFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm64", "Hardswish", HardswishFP32Impl64::SelectFunc, HardswishFP32Impl64::default_prio);
}
