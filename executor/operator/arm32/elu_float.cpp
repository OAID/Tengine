...
using namespace EluFP32Impl32;

void RegisterEluFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", "Elu", EluFP32Impl32::SelectFunc, EluFP32Impl32::default_prio);
}
