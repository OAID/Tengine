...
using namespace AbsvalFP32Impl32;
void RegisterAbsvalFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", "Absval", AbsvalFP32Impl32::SelectFunc,
                                                  AbsvalFP32Impl32::default_prio);
}
