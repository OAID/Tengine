...
using namespace TanhFP32Impl32;
void RegisterTanhFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", "Tanh", TanhFP32Impl32::SelectFunc,
                                                  TanhFP32Impl32::default_prio);
}
