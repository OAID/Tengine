...
using namespace PReluFP32Impl32;

void RegisterPReluFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", "PReLU", PReluFP32Impl32::SelectFunc, PReluFP32Impl32::default_prio);
}
