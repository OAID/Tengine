...
using namespace BatchNormImpl32;

void RegisterBatchNormNodeExec(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", BatchNormName, BatchNormImpl32::SelectFunc, 1000);
}
