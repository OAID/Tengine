...
static int tm2_load_softplus(struct ir_graph* ir_graph, struct ir_node* ir_node, const TM2_Node* tm_node,
...
REGISTER_MODULE_INIT(MOD_OP_LEVEL, "reg_softplus_ops", reg_tm2_ops);
REGISTER_MODULE_EXIT(MOD_OP_LEVEL, "unreg_softplus_ops", unreg_tm2_ops);
