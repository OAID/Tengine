...
static int tm2_load_l2normalization(struct ir_graph* ir_graph, struct ir_node* ir_node, const TM2_Node* tm_node,
...
static int unreg_tm2_ops(void* arg)
{
    ...
    tm2_s->unregister_op_loader(tm2_s, TM2_OPTYPE_L2NORMALIZATION, 1, tm2_load_l2normalization);

    return 0;
}

REGISTER_MODULE_INIT(MOD_OP_LEVEL, "reg_l2normalization_ops", reg_tm2_ops);
REGISTER_MODULE_EXIT(MOD_OP_LEVEL, "unreg_l2normalization_ops", unreg_tm2_ops);
