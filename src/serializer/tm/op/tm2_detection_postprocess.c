...
static int tm2_load_detection_postprocess(struct ir_graph* ir_graph, struct ir_node* ir_node, const TM2_Node* tm_node,
...
REGISTER_MODULE_INIT(MOD_OP_LEVEL, "reg_detection_postprocess_ops", reg_tm2_ops);
REGISTER_MODULE_EXIT(MOD_OP_LEVEL, "unreg_detection_postprocess_ops", unreg_tm2_ops);
