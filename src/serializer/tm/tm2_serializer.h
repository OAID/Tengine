...
#ifndef __TM2_SERIALIZER_H__
#define __TM2_SERIALIZER_H__
...
typedef int (*tm2_op_loader_t)(struct ir_graph*, struct ir_node*, const TM2_Node*, const TM2_Operator* tm_op);
