...
static int register_squareddifference_op(void* arg)
{
    struct op_method m;
...
static int unregister_squareddifference_op(void* arg)
{
    return unregister_op(OP_SQUAREDDIFFERENCE, 1);
}

AUTO_REGISTER_OP(register_squareddifference_op);
AUTO_UNREGISTER_OP(unregister_squareddifference_op);
