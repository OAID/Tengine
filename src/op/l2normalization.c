...
static int register_l2normalization_op(void* arg)
{
    struct op_method m;
...
static int unregister_l2normalization_op(void* arg)
{
    return unregister_op(OP_L2NORMALIZATION, 1);
}

AUTO_REGISTER_OP(register_l2normalization_op);
AUTO_UNREGISTER_OP(unregister_l2normalization_op);
