...
static int register_softplus_op(void* arg)
{
    struct op_method m;
...
static int unregister_softplus_op(void* arg)
{
    return unregister_op(OP_RECIPROCAL, 1);
}

AUTO_REGISTER_OP(register_softplus_op);
AUTO_UNREGISTER_OP(unregister_softplus_op);
