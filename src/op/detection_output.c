...
DEFINE_PARM_PARSE_ENTRY(detection_output_param, num_classes, keep_top_k, nms_top_k, confidence_threshold,
                        nms_threshold);
...
{
    sys_free(GET_PARAM_PARSE_MAP(detection_output_param));
