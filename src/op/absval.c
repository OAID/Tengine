...
static int register_absval_op(void* arg)
{
    struct op_method m;
...
static int unregister_absval_op(void* arg)
{
    return unregister_op(OP_ABSVAL, 1);
}

AUTO_REGISTER_OP(register_absval_op);
AUTO_UNREGISTER_OP(unregister_absval_op);
