...
static int ref_spacetobatchnd_fp32(struct ir_tensor* input_tensor, struct ir_tensor* output_tensor,
...
static int ref_spacetobatchnd_uint8(struct ir_tensor* input_tensor, struct ir_tensor* output_tensor,
                                   struct spacetobatchnd_param* param, int num_thread)
{
    /* dequant */
...
static int reg_spacetobatchnd_hcl_ops(void* arg)
{
    return register_builtin_node_ops(OP_SPACETOBATCHND, &hcl_node_ops);
}

static int unreg_spacetobatchnd_hcl_ops(void* arg)
{
    return unregister_builtin_node_ops(OP_SPACETOBATCHND, &hcl_node_ops);
}

AUTO_REGISTER_OPS(reg_spacetobatchnd_hcl_ops);
AUTO_UNREGISTER_OPS(unreg_spacetobatchnd_hcl_ops);
