...
static inline float arm64_max(float a, float b)
{
    if (a > b)
        return a;
    else
...
static inline float arm64_min(float a, float b)
{
    if (a > b)
        return b;
    else
    ...
    for (int c = 0; c < inc; c++)
    {
        ...
        for (int i = 0; i < outh; i++)
        {
            ...
            for (int j = block_w * 4; j < outw; j++)
            {
                ...
                *out_ptr = arm64_max(_max[0], _max[1]);
                out_ptr++;
                line0 += 2;
                line1 += 2;
            }
            ...
            if (pad_w1 > 0)
            {
                *out_ptr = arm64_max(line0[0], line1[0]);
                out_ptr++;
            }
            line0 += remain_w + inw;
            line1 += remain_w + inw;
...

{
    ...
    for (int c = 0; c < inc; c++)
    {
        ...
        for (int i = 0; i < outh; i++)
        {
            ...
            if (pad_w1 == 1)
            {
                float max0 = arm64_max(arm64_max(line0[0], line0[1]), arm64_max(line1[0], line1[1]));
                *out_ptr = arm64_max(arm64_max(line2[0], line2[1]), max0);
                out_ptr++;
            }
            line0 += remain_w + inw;
            line1 += remain_w + inw;
        ...
        if (pad_h1 == 1)
        {
            ...
            if (pad_w1 == 1)
            {
                *out_ptr = arm64_max(arm64_max(line0[0], line0[1]), arm64_max(line1[0], line1[1]));
                out_ptr++;
            }
        }
    }
                         ...
                         int k_w, int s_h, int s_w, int pad_h0, int pad_w0, int pad_h1, int pad_w1, int is_caffe)
{
    ...
    for (int c = 0; c < inc; c++)
    {
        ...
        *out_ptr = line00[0];
        ...
        for (int j = block_w * 4 + 1; j < outw; j++)
        {
            *out_ptr = arm64_max(line00[0], line00[1]);
            out_ptr++;
            line00 += 2;
        }
        if (inw % 2 == 0)
        ...
        if (inh % 2 == 0)
        {
            *out_ptr = line0[0];
            ...
            for (int j = block_w * 4 + 1; j < outw; j++)
            {
                *out_ptr = arm64_max(line0[0], line0[1]);
                out_ptr++;
                line0 += 2;
            }
            if (inw % 2 == 0)
...

{
    ...
    for (int c = 0; c < inc; c++)
    {
        ...
        *out_ptr = arm64_max(arm64_max(line1[0], line1[1]), arm64_max(line2[0], line2[1]));
        ...
        {
            *out_ptr = arm64_max(line1[0], line2[0]);
            out_ptr++;
        }
        line1 += remain_w;
        line2 += remain_w;
        ...
        for (int i = 1; i < outh; i++)
        {
            ...
            *out_ptr = arm64_max(arm64_max(line0[0], line0[1]), max0);
            ...
            {
                *out_ptr = arm64_max(arm64_max(line0[0], line1[0]), line2[0]);
                out_ptr++;
            }
            line0 += inw + remain_w;
            line1 += inw + remain_w;
        ...
        else if (inh % 2 == 0 && is_caffe == 1)
        {
            *out_ptr = arm64_max(line0[0], line0[1]);
            ...
            for (int j = block_w * 4 + 1; j < outw; j++)
            {
                *out_ptr = arm64_max(arm64_max(line0[0], line0[1]), line0[2]);
                       ...
                       int k_w, int s_h, int s_w, int pad_h0, int pad_w0, int pad_h1, int pad_w1, int is_caffe)
{
    ...
    for (int c = 0; c < inc; c++)
    {
        ...
        float max_ = arm64_max(arm64_max(res[0], res[1]), arm64_max(res[2], res[3]));
        for (int j = tail; j < in_hw; j++)
        {
            max_ = arm64_max(max_, line0[0]);
            line0++;
        }
        *out_ptr = max_;
    }
