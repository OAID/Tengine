...
#include "x86/conv_dw_kernel_x86.h"
#include <math.h>
...
static int convdw3x3s1_int8_sse(struct ir_tensor* input_tensor, struct ir_tensor* weight_tensor, struct ir_tensor* bias_tensor,
                               struct ir_tensor* output_tensor, struct conv_param* param, int num_thread)
{
    ...
    {
        input_tmp = ( int8_t* )sys_malloc((unsigned long)inh_tmp * inw_tmp * inch * sizeof(int8_t));
...
static int convdw3x3s2_int8_sse(struct ir_tensor* input_tensor, struct ir_tensor* weight_tensor, struct ir_tensor* bias_tensor,
                              struct ir_tensor* output_tensor, struct conv_param* param, int num_thread)
{
    int inch = input_tensor->dims[1];
    int inh = input_tensor->dims[2];
...
static int conv_dw_run_int8(struct ir_tensor* input_tensor, struct ir_tensor* weight_tensor, struct ir_tensor* bias_tensor,
                               struct ir_tensor* output_tensor, struct conv_param* param, int num_thread)
{
    int ret = -1;
