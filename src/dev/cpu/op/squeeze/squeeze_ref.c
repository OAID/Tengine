...
int ref_squeeze_fp32(struct ir_tensor* input_tensor, struct ir_tensor* output_tensor)
{
...
int ref_squeeze_uint8(struct ir_tensor* input_tensor, struct ir_tensor* output_tensor)
{
