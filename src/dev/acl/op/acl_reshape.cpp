...
bool CLGraph::AddReshapeLayer(struct ir_node* node)
{
    ...
    if (input_tensor->layout == TENGINE_LAYOUT_NCHW)
    {
        ...
        tensors_map_[std::to_string(node->idx+0.1).c_str()] = permute0_tensor;
