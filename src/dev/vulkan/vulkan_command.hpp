...
public:
    void record_upload(ir_tensor* src, VkTensor& dst, const Option& opt);
    void record_upload(const Tensor& src, VkTensor& dst, const Option& opt);

    void record_download(const VkTensor& src, ir_tensor* dst, const Option& opt);
...
public:
    ...
    ~VkTransfer();
public:
    void record_upload(const ir_tensor* src, VkTensor& dst, const Option& opt);
    void record_upload(const Tensor& src, VkTensor& dst, const Option& opt);
