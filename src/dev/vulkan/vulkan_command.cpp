...
void VkCompute::record_upload(ir_tensor* src, VkTensor& dst, const Option& opt)
{
...
void VkCompute::record_download(const VkTensor& src, ir_tensor* dst, const Option& opt)
{
    Tensor dst_tensor;
...
void VkTransfer::record_upload(const ir_tensor* src, VkTensor& dst, const Option& opt)
{
//     TLOG_INFO("record_upload src = %d | %d %d %d @ %d", src.dims, src.w, src.h, src.c, src.elempack);
