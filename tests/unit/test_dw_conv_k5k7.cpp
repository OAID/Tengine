...
graph_t create_conv_graph(int c, int h, int w, int k, int s)
{
    ...
    if(create_conv_node(graph, conv_name, input_name, k, s, k/2, c, c, c) < 0)
    {
...
int main(int argc, char* argv[])
{
    ...
    graph_t graph = create_conv_graph(c, h, w, k, s);
    graph_t graph1 = create_conv_graph(c, h, w, k, s);
