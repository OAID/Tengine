...
std::string node = "pad_reflect";
std::string input_0_pb = "../onnx_node/" + node + "/test_data_set_0/input_0.pb";
std::string input_1_pb = "../onnx_node/" + node + "/test_data_set_0/padding.pb";
std::string output_pb = "../onnx_node/" + node + "/test_data_set_0/output.pb";
...
int main(int argc, char* argv[])
{
    ...
    std::vector<float> feature_in_1(input_size);
