...
int main(int argc, char* argv[])
{
    ...
    // create
    struct graph* ir_graph = (struct graph*)create_torch_test_graph(test_node_name, data_type, layout, n, c, h, w, &create_test_convolution_node);
    if (NULL == ir_graph)
        return -1;
    ...
    int output_num = output_tensor->elem_num;
