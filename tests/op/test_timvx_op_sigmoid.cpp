...
int create_test_sigmoid_node(graph_t graph, const char* input_name, const char* node_name, int data_type, int layout,
...
float output_scale      = 0.0039216f;
int   output_zero_point = 0;

int main(int argc, char* argv[])
{
    int         n = 1, c = 3, h = 4, w = 5;
    const char* test_node_name = "sigmoid";
