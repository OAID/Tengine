...
const char * text_file="./tests/data/mobilenet-symbol.json";
const char * model_file="./tests/data/mobilenet-0000.params";
...
int main(int argc, char * argv[])
{
  ...
  /* setup output buffer */
   ...
   printf("Repeat [%d] times %.2f per RUN, used [%lu] us\n",
         repeat_count,1.0f*(end_time-start_time)/repeat_count, end_time-start_time);
