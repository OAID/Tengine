...
#define DEF_PROTO "models/yufacedetect/yufacedetectnet-open-v1_new.prototxt"
#define DEF_MODEL "models/yufacedetect/yufacedetectnet-open-v1_new.caffemodel"
#define DEF_IMAGE "tests/images/yufacedetect.jpg"
