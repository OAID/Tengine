...
void get_input_data_yolov3(const char* image_file, float* input_data, int img_h, int img_w, const float* mean,
                           const float* scale)
{
...
int main(int argc, char* argv[])
{
    ...
    get_input_data_yolov3(image_file, input_data, img_h, img_w, mean, scale);
