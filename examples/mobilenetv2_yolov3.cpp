...
int main(int argc, char* argv[])
{
    ...
    std::string image_file = root_path + "./tests/images/ssd_dog.jpg";
    int layer_type = 0;
    std::string model_name = "yolov3";
    std::string text_file = root_path + "./models/mobilenet_yolov3_lite_deploy.prototxt";
    std::string model_file = root_path + "./models/mobilenet_yolov3_lite_deploy.caffemodel";
    std::string model_file_tm = root_path + "models/yolov3_dk.tmfile";
   ...
   int img_h = im.h;
    ...
    graph_t graph = create_graph(nullptr, "tengine",  model_file_tm.c_str());
    if(graph == nullptr)
    {
