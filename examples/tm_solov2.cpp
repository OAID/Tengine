...
int main(int argc, char* argv[])
{
    ...
    if (input_tensor == nullptr || p3_input_tensor == nullptr|| 
		p4_input_tensor == nullptr|| p5_input_tensor == nullptr)
    {
    ...
    if (set_tensor_shape(input_tensor, dims, 4) < 0 || 
		set_tensor_shape(p3_input_tensor, dims3, 4) < 0||
		set_tensor_shape(p4_input_tensor, dims4, 4) < 0||
		set_tensor_shape(p5_input_tensor, dims5, 4) < 0)
    {
    ...
    if (set_tensor_buffer(input_tensor, input_data.data(), img_size * 4) < 0||
		set_tensor_buffer(p3_input_tensor, input_data3.data(), 2 * 56 * 56 * 4) < 0||
		set_tensor_buffer(p4_input_tensor, input_data4.data(), 2 * 28 * 28 * 4) < 0||
		set_tensor_buffer(p5_input_tensor, input_data5.data(), 2 * 14 * 14 * 4) < 0)
    {
