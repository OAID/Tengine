...
void get_input_data_yolov4_uint8(const char* image_file, uint8_t* input_data, int img_h, int img_w, const float* mean,
...
static void draw_objects(const cv::Mat& bgr, const std::vector<Object>& objects)
{
    ...
    cv::imwrite("yolov4_uint8_out.jpg", image);
}
...
int main(int argc, char* argv[])
{
    ...
    get_input_data_yolov4_uint8(image_file, input_data.data(), img_h, img_w, mean, scale, input_scale,
                                input_zero_point);
    ...
    generate_proposals(8, p8_data.data(), prob_threshold, objects8);
