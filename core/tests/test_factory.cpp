...
struct B: public base {
	...
	void f() { std::cout<<"B val: "<<val<<"\n";}
	void g() { std::cout<<"number: "<<number<<"\n";}
...
struct G {
	...
	G()  { std::cout<<"No argument called\n"; }

	G(int a) { std::cout<<"int a ="<<a<<"\n"; }

	G(const char * s) { std::cout<<"const char * is: "<<s<<"\n"; }

	G(const std::string& h) { std::cout<<"const string is: "<<h<<"\n"; }

	G(std::string&& r) { std::cout<<"rval str is: "<< r<<"\n";}
