...
class A {
	...
	public:
		...
		A& operator=(int n) { val_=n; return * this;}

		~A() { std::cout<<"A destructed: "<<val_<<std::endl;}
...
class B {
	public:
		...
		B(const std::string& d) { str_=d; };

		B& operator=(const std::string& s) {str_=s; return * this;};

		~B() { std::cout<<"B destructed: "<<str_<<std::endl;};
...
int main(int argc, char * argv[])
{
	...
	std::cout << std::endl;
	OutputTypeName("_ZZN7TEngine12ClassFactory12RegisterTypeI2A2IEEEvRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEENKUlvE_clEv");
	std::cout << std::endl;
