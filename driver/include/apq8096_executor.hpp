...
#ifndef __APQ8096_EXECUTOR_HPP__
#define __APQ8096_EXECUTOR_HPP__
...
class APQ8096Executor: public GenericDevExecutor {

public:

	APQ8096Executor(const dev_id_t& dev_id) {dev_id_=dev_id;}
