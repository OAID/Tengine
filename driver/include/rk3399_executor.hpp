...
#ifndef __RK3399_EXECUTOR_HPP__
#define __RK3399_EXECUTOR_HPP__
...
class RK3399Executor: public GenericDevExecutor {

public:

	RK3399Executor(const dev_id_t& dev_id) {dev_id_=dev_id;}
