...
inline Tensor::Tensor(int _n, int _w, size_t _elem_size, uint8_t _layout)
    : dim_num(0), layout(0), elem_size(0), elem_num(0), data(0), n(0), c(0), h(0), w(0)
{
    create(_n, _w, _elem_size, _layout);
}

inline Tensor::Tensor(int _n, int _w, int _h, size_t _elem_size, uint8_t _layout)
    : dim_num(0), layout(0), elem_size(0), elem_num(0), data(0), n(0), c(0), h(0), w(0)
{
    create(_n, _h, _w, _elem_size, _layout);
}

inline Tensor::Tensor(int _n, int _w, int _h, int _c, size_t _elem_size, uint8_t _layout)
    : dim_num(0), layout(0), elem_size(0), elem_num(0), data(0), n(0), c(0), h(0), w(0)
{
    create(_n, _c, _h, _w, _elem_size, _layout);
}
