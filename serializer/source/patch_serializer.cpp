...
static int create_c_file(const char * model_name,int patch_idx,char * addr, int offset, int size,
		         int total_size,uint32_t vendor_id, uint32_t nn_id,const char *reg_func)
{
