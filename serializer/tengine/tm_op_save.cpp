...
static tm_uoffset_t SaveTmAccuracyOp(void *const start_ptr,
                                     tm_uoffset_t *cur_pos, Operator *op) {
  TM_Operator tm_op;
  SetTmOperator(&tm_op, TM_OPTYPE_ACCURACY, NOT_SET, NOT_SET);
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmBatchNormOp(void *const start_ptr,
                                      tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_BATCHNORMALIZATION, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_BatchNormParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmConcatOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                   Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_CONCAT, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ConcatParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmConstOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  TM_Operator tm_op;
...
static tm_uoffset_t SaveTmConvOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                 Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_CONVOLUTION, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ConvParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmDeconvOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                   Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_DECONVOLUTION, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_DeconvParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmDetectionOutputOp(void *const start_ptr,
                                            tm_uoffset_t *cur_pos,
                                            Operator *op) {
  ...
  SetTmOperator(&tm_op, TM_OPTYPE_DETECTIONOUTPUT, NOT_SET,
                WriteTmObject(start_ptr, cur_pos, &tm_param,
                              sizeof(TM_DetectionOutputParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmDropoutOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  TM_Operator tm_op;
...
static tm_uoffset_t SaveTmEltwiseOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_ELTWISE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_EltwiseParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmFCOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                               Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_FULLYCONNECTED, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_FCParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmFlattenOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_FLATTEN, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_FlattenParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmInputOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  TM_Operator tm_op;
...
static tm_uoffset_t SaveTmLRNOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_LRN, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_LRNParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmNormalizeOp(void *const start_ptr,
                                      tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_NORMALIZE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_NormalizeParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmPermuteOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_PERMUTE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_PermuteParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmPoolOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                 Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_POOLING, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_PoolParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmPreluOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  TM_Operator tm_op;
...
static tm_uoffset_t SaveTmPriorBoxOp(void *const start_ptr,
                                     tm_uoffset_t *cur_pos, Operator *op) {
  ...
  tm_param.offset_vf_min_size =
      WriteTmObject(start_ptr, cur_pos, v_minsizes, vector_size);
  free(v_minsizes);
  ...
  tm_param.offset_vf_max_size =
      WriteTmObject(start_ptr, cur_pos, v_maxsizes, vector_size);
  free(v_maxsizes);
  ...
  tm_param.offset_vf_variance =
      WriteTmObject(start_ptr, cur_pos, v_variance, vector_size);
  free(v_variance);
  ...
  tm_param.offset_vf_aspect_ratio =
      WriteTmObject(start_ptr, cur_pos, v_ratios, vector_size);
  free(v_ratios);
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_PRIORBOX, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_PriorBoxParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmRegionOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                   Operator *op) {
  ...
  tm_param.offset_vf_biases =
      WriteTmObject(start_ptr, cur_pos, v_biases, vector_size);
  free(v_biases);

  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_REGION, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_RegionParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmReLuOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                 Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_RELU, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ReLuParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmRelu6Op(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  TM_Operator tm_op;
...
static tm_uoffset_t SaveTmReorgOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_REORG, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ReorgParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmReshapeOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_RESHAPE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ReshapeParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmResizeOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                   Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_BILINEARRESIZE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ResizeParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmROIPoolingOp(void *const start_ptr,
                                       tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_ROIPOOLING, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ROIPoolingParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmRPNOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                Operator *op) {
  ...
  tm_param.offset_vf_anchor_scales =
  ...
  tm_param.offset_va_anchors =
      WriteTmObject(start_ptr, cur_pos, v_anchors, vector_size);
  free(v_anchors);
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_RPN, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_RPNParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmScaleOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_SCALE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_ScaleParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmSliceOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_SLICE, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_SliceParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmSoftmaxOp(void *const start_ptr,
                                    tm_uoffset_t *cur_pos, Operator *op) {
  ...
  TM_Operator tm_op;
  SetTmOperator(
      &tm_op, TM_OPTYPE_SOFTMAX, NOT_SET,
      WriteTmObject(start_ptr, cur_pos, &tm_param, sizeof(TM_SoftmaxParam)));
  return WriteTmObject(start_ptr, cur_pos, &tm_op, sizeof(TM_Operator));
}

static tm_uoffset_t SaveTmSplitOp(void *const start_ptr, tm_uoffset_t *cur_pos,
                                  Operator *op) {
  TM_Operator tm_op;
...
tm_uoffset_t SaveTmOperator(void *const start_ptr, tm_uoffset_t *cur_pos,
                            Operator *op) {
