...
bool FeatureMatch::InferShape(const std::vector<TEngine::TShape>& ishape, std::vector<TEngine::TShape>& oshape,
                              int layout)
{
...
float FeatureMatch::GetFops(const std::vector<TShape>& inputs, const std::vector<TShape>& outputs)
{
